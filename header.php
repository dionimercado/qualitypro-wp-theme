...
<body <?php body_class() ?>>
  <nav id="header" class="navbar navbar-expand-lg navbar-light bg-light">
    <div class="container">
      ...
      <button class="navbar-toggler border-0 p-0" type="button" data-toggle="collapse" data-target="#qualityproNav" aria-controls="qualityproNav" aria-expanded="false" aria-label="Toggle navigation">
